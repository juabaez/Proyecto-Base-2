...
public class Indice {
    ...
    public String comparacionIndice(Indice other, String nombreTabla, String nombreBD1, String nombreBD2){
        String res="";
        if (!this.detalle.equals(other.getDetalle())) {
            res = res + "Mientras que el indice '"+this.nombre+"' de la tabla '"+nombreTabla+"' en la base de datos '"+nombreBD1+"' tiene como detalle '"+this.detalle+
